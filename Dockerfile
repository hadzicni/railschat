...
# docker build -t projektarbeit_chatapp .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name projektarbeit_chatapp projektarbeit_chatapp
